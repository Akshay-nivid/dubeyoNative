...
const ProductCard: React.FC<ProductCardProps> = ({
        ...
        try {
          ...
          if (isMounted) {
            if (result) {
              ...
              setAddress(
                item.locationName || `${lat.toFixed(2)}, ${lon.toFixed(2)}`,
              );
            }
          }
        } catch (e) {
  ...
  const extractCurrencyAndPrice = (
    priceStr: string,
  ): { currency: string; priceValue: string } => {
            ...
            <View className="flex-row items-center mb-1 gap-1">
              {availableSpecs.map((spec, index) => (
                <View key={index} className="flex-1 flex-row items-center">
                  ...
                  />
                  <Text
                    className="text-[9px] text-text_tertiary ml-0.5 flex-1"
                    numberOfLines={1}
                  >
                    {spec.value}
                  </Text>
          ...
          <View className="flex-row items-center justify-between mt-0.5">
            ...
            {address ? (
              <View className="flex-row items-center flex-1">
                ...
                <Text
                  className="text-[10px] text-red-500 ml-1 flex-1"
                  numberOfLines={1}
                >
                  {address}
                </Text>
            ...
            {item.seller?.name && (
              <View className="flex-row items-center ml-2">
                ...
                <Text
                  className="text-[10px] text-text_tertiary"
                  numberOfLines={1}
                >
                  {item.seller.name}
                </Text>
            ...
            <View className="mb-3">
              ...
              {availableSpecs.length > 0 && (
                <View className="flex-row mb-2">
                  <View className="flex-1 flex-row items-center mr-2">
                    <Ionicons
                      name={availableSpecs[0].icon as any}
                      size={14}
                      color={colors.text_tertiary}
                    />
                    <Text
                      className="text-sm text-text_primary ml-1 flex-1"
                      numberOfLines={1}
                    >
                  ...
                  {availableSpecs.length > 1 && (
                    <View className="flex-1 flex-row items-center ml-2">
                      <Ionicons
                        name={availableSpecs[1].icon as any}
                        size={14}
                        color={colors.text_tertiary}
                      />
                      <Text
              ...
              {availableSpecs.length > 2 && (
                <View className="flex-row">
                  <View className="flex-1 flex-row items-center mr-2">
                    <Ionicons
                      name={availableSpecs[2].icon as any}
                      size={14}
                      color={colors.text_tertiary}
                    />
                    <Text
                  ...
                  {availableSpecs.length > 3 && (
                    <View className="flex-1 flex-row items-center ml-2">
                      <Ionicons
                        name={availableSpecs[3].icon as any}
                        size={14}
                        color={colors.text_tertiary}
                      />
                      <Text
        ...
        <View className="flex-row items-center ml-4">
          {item.seller?.profilePic ? (
            ...
            <View className="w-6 h-6 rounded-full bg-bg_secondary justify-center items-center mr-2">
              <Ionicons name="person" size={14} color={colors.text_tertiary} />
            </View>
          )}
          <View>
