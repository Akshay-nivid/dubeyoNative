    ...
    if (loading) {
        return (
            <View className="flex-1 bg-bg_primary items-center justify-center">
                ...
                <Text className="mt-4 text-base text-text_tertiary">Loading security settings...</Text>
            </View>
        );
    }
                    ...
                    <View className="mb-6">
                        ...
                        {!isEditingPassword ? (
                            ...
                            <View className="bg-white rounded-xl p-4 border border-border_primary">
                                ...
                                />
                                {errors.oldPassword && (
                                    <Text className="text-sm mb-2 ml-1" style={{ color: colors.error }}>
                                        {errors.oldPassword}
                                    </Text>
                                )}
                                ...
                                <View className="flex-row justify-end gap-3 mt-4">
                                    ...
                                    <Pressable
                                        ...
                                        style={{
                                            backgroundColor: saving ? colors.bg_gray_400 : colors.primary,
                                            shadowColor: "#000",
