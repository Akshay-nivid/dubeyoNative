    ...
    try {
      ...
      if (userData) {
        ...
        if (
          ...
          if (
            userData.profilePic.includes("googleusercontent") ||
            ...
            try {
              const imageResponse = await get(
                `${Api.Image}?key=${userData.profilePic}`,
              );
              profileImageUrl =
        ...
        if (userData.createdAt || userData.created_at || userData.joinedDate) {
          joinedDate =
            userData.createdAt || userData.created_at || userData.joinedDate;
        }
    ...
    <View className="flex-1 bg-gray-50">
      ...
      >
            ...
            <View className="flex-1 ml-4 mb-2">
              <View className="flex-row justify-between items-start">
                <View className="flex-1">
                  ...
                  <Text
                    className="text-blue-900 text-sm font-medium mt-1"
                    numberOfLines={1}
                  >
        ...
        <View className="mt-6 px-4">
          <Text className="text-lg font-bold text-gray-900 mb-3 ml-1">
            Personal
          </Text>
